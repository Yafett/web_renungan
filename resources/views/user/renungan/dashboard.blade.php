...
<body>
    ...
    <div style="cursor: pointer;" onclick="window.location='/renungan/anak';">
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 container_foto mt-3">
            <div class="ver_mas text-center">
                <span id="click" class="lnr lnr-eye"></span>
            </div> 
            <img src="{{ asset('img/anak.jpg') }}" style="height: 340px;">
        </div>    
    </div>    
    ...
    <div style="cursor: pointer;" onclick="window.location='/';">
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 container_foto mt-3">
            ...
            <img src="{{ asset('img/remaja.jpg') }}" style="height: 340px;">
        </div>    
    </div>    
    ...
    <div style="cursor: pointer;" onclick="window.location='/';">
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 container_foto mt-3">
            ...
            <img src="{{ asset('img/dewasa.jpg') }}" style="height: 340px;">
        </div>    
    </div>    
